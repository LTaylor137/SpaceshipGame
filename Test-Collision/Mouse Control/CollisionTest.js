...
var context, controller, Rectangle, red, white, yellow, loop, resize;
...
yellow = new Rectangle(context.canvas.width * 0.5 - 32, context.canvas.height * 0.5 - 32, 32, 32, "#ffff80");
...
loop = function(time_stamp) {
  ...
  if (red.testCollision(white)) {
    ...
    context.stroke();
    console.log(" red is colliding with white ")

  }

  if (red.testCollision(yellow)) {

    context.beginPath();
    context.rect(red.x, red.y, red.width, red.height);
    context.rect(yellow.x, yellow.y, yellow.width, yellow.height);
    context.strokeStyle = "#ffffff";
    context.stroke();
    console.log(" red is colliding with yellow ")
...
resize = function(event) {
  ...
  yellow.x = context.canvas.width * 0.5 - 150;
  yellow.y = context.canvas.height * 0.5 - 100;
